...
class Register extends React.Component {
	...
	registerUser = () => {
		...
		axios.post(`http://localhost:4000/register_user`, userInfo).then(response => {
				...
				<PageContainer>
					<RegisterContainer>
						...
						<Contents>
							...
							<ButtonContainer>
								<HeroButton onClick={this.registerUser} width="60%">CREATE ACCOUNT</HeroButton>
...
function mapStateToProps(state) {
	return { loggedInStatus: state.loggedInStatus, profile_id: state.userData.uplay }
}
